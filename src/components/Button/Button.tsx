  ...
  return (
    <button
      ...
      className={clsx(
        ...
        buttonType === 'outlined' &&
          'border bg-white border-gray-400 text-primary-40 shadow-none',
        buttonType === 'text' &&
          'bg-transparent hover:bg-primary-90 text-primary-40 shadow-none',
        buttonType === 'elevated' &&
          'bg-primary-90 text-primary-40 drop-shadow-md',
        buttonType === 'tonal' &&
          'bg-primary-90 hover:bg-primary-70 text-black shadow-none',
